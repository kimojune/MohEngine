...
public:
	...
	bool CreateTexture2D(const D3D11_TEXTURE2D_DESC* desc, void* date, ID3D11Texture2D** ppTexture2D);
	...
	bool CreateComputeShader(const void* pShaderBytecod, SIZE_T BytecodeLength, ID3D11ComputeShader** ppComputeShader);
	...
	void BindBuffer(ID3D11Resource* buffer, void* data, UINT size);
